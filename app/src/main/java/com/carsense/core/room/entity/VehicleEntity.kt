...
data class VehicleEntity(
    ...
    val serverId: Int? = null, // From Neon DB, nullable until synced
    @ColumnInfo(name = "uuid")
    val uuid: String = UUID.randomUUID().toString(), // Client-generated UUID
    ...
    @ColumnInfo(name = "vehicle_identification_number")
